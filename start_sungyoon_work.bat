...
call :switch_branch sungyoon-codex
if errorlevel 1 goto :switch_failed

echo.
echo Branch switch successful: sungyoon-codex
echo Current branch:
...
echo Pulling latest origin/sungyoon-codex...
git pull --rebase origin sungyoon-codex
...
:switch_failed
echo.
echo ERROR: Could not switch to sungyoon-codex.
